...
public class ChoisirNiveau extends JFrame implements KeyListener {
	...
	Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize(); // ces lignes vont servir a connaitre
	int width = (int) screenSize.getWidth();//la taille des ecrans de l'utilisateur.
	int height = (int) screenSize.getHeight();
	private JButton NiveauStatique1;//chaque bouton correspondra a un bouton de palier
	private JButton NiveauStatique2;//NiveauStatique2 est le 2eme palier du mode statique.
	private JButton NiveauStatique3;//
	private JButton NiveauStatique4;//
	private JButton NiveauMobile1;// NiveauMobile est le 1er palier du mode mobile
	private JButton NiveauMobile2;//
	private JButton NiveauMobile3;//
	private JButton NiveauMobile4;//
	private JButton MenuPrincipal;//
	double w = width / 1.75;  //on prend dans une variable la largeur de l'ecran divisee par 1.75
	double h = height / 1.5;  // on prend dans une variable la hauteur de l'ecran divisee par 1.5
	...
	public ChoisirNiveau() {
		...
		Font police = new Font("Verdana", Font.BOLD, 15);  // on choisi la police du texte

		this.NiveauStatique1 = new JButton("Niveau Statique1"); // on cree le bouton qui permettra de lancer un palier
		this.NiveauStatique1.setBackground(Color.WHITE);// statique de difficulte 1, et on le place au bon endroit
		...
		this.NiveauMobile1 = new JButton("Niveau mobile1"); // on cree le bouton qui permettra de lancer le palier 
		this.NiveauMobile1.setBackground(Color.WHITE); // de niveau mobile de difficulte 1 et on le place 
		...
		this.MenuPrincipal = new JButton("Menu Principal"); // on place un bouton permettant 
		this.MenuPrincipal.setBackground(Color.WHITE);// de revenir au menu principal
		...
		this.NiveauStatique1.addActionListener(new ActionListener() {  // on choisi l'action au clic du bouton

			public void actionPerformed(ActionEvent e) {

				dispose();

				PlateauBulle N1 = new PlateauBulle(5, 1, 0); // on lance un palier correspond a la difficulte 1 
		...
		this.MenuPrincipal.addActionListener(new ActionListener() { // on choisi l'action au lic du bouton menu principal
